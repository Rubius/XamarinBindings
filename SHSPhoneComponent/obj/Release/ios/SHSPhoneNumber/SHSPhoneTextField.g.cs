...
namespace SHSPhoneNumber {
	...
	public unsafe partial class SHSPhoneTextField : global::UIKit.UITextField {
		...
		[CompilerGenerated]
		public unsafe virtual SHSTextBlock TextDidChangeBlock {
			[return: DelegateProxy (typeof (ObjCRuntime.Trampolines.SDSHSTextBlock))]
			[Export ("textDidChangeBlock", ArgumentSemantic.Copy)]
			get {
				IntPtr ret;
				if (IsDirectBinding) {
					ret = global::ApiDefinition.Messaging.IntPtr_objc_msgSend (this.Handle, Selector.GetHandle ("textDidChangeBlock"));
				} else {
					ret = global::ApiDefinition.Messaging.IntPtr_objc_msgSendSuper (this.SuperHandle, Selector.GetHandle ("textDidChangeBlock"));
				}
				return global::ObjCRuntime.Trampolines.NIDSHSTextBlock.Create (ret);
			}
			
			[Export ("setTextDidChangeBlock:", ArgumentSemantic.Copy)]
			set {
				if (value == null)
				...
				block_value.SetupBlock (Trampolines.SDSHSTextBlock.Handler, value);
				
				if (IsDirectBinding) {
					global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr (this.Handle, Selector.GetHandle ("setTextDidChangeBlock:"), (IntPtr) block_ptr_value);
				} else {
					global::ApiDefinition.Messaging.void_objc_msgSendSuper_IntPtr (this.SuperHandle, Selector.GetHandle ("setTextDidChangeBlock:"), (IntPtr) block_ptr_value);
				}
