...
namespace WenchaoD.FSCalendarBindings
{
    ...
    [BaseType(typeof(UICollectionViewCell))][Protocol]
    ...
    [BaseType(typeof(UICollectionViewFlowLayout))][Protocol]
    ...
    [BaseType(typeof(UICollectionView))][Protocol]
    interface FSCalendarCollectionView
    {
    }

    // @interface FSCalendarSeparator : UICollectionReusableView
    [BaseType(typeof(UICollectionReusableView))][Protocol]
